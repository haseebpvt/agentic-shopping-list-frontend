...
class _AiSuggestionsScreenState extends State<AiSuggestionsScreen> {
  ...
  Future<void> _onRefresh() async {
    context.read<ShoppingListBloc>().add(
      RefreshShoppingList(userId: widget.userId),
    );
  }
        ...
        child: Stack(
          children: [
                ...
                Expanded(
                  ...
                  if (state is ShoppingListLoading) {
                    ...
                    return Center(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () => context
                                ...
                                .add(LoadShoppingList(userId: widget.userId)),
                      ...
                      state is ShoppingListInserting) {
                    ...
                    final categories = groupedItems.keys.toList()..sort();
                     ...
                     return RefreshIndicator(
                       ...
                       child: ListView.builder(
                         physics: const AlwaysScrollableScrollPhysics(),
                         padding: const EdgeInsets.fromLTRB(16, 16, 16, 180), // Extra bottom padding for mic
                            ...
                            children: [
                              ...
                              ...categoryItems.map(
                                (item) => Card(
                                  ...
                                  elevation: 2,
                                  child: Container(
                                    decoration: item.isAiSuggestion
                                        ? BoxDecoration(
                                            border: Border.all(
            ...
            // Bottom action bar with keyboard and mic buttons
             // Bottom action bar with keyboard far left and centered mic
             SizedBox(
               height: 160, // Give space for large mic animation
               child: Stack(
                 children: [
                   // Keyboard button positioned far left
                   Positioned(
                     left: 24,
                   ...
                   // Centered mic with large size
                   Center(
                     child: InlineVoiceRecordingWidget(
                       userId: widget.userId,
                       size: 120, // Much larger mic size
                     ),
                   ),
                 ],
               ),
            ...
            // Gradient overlay for loading states
            BlocBuilder<ShoppingListBloc, ShoppingListState>(
              builder: (context, state) {
                ...
                return AIGradientWidget(
                  ...
                  heightPercentage: 0.3, // Cover bottom 30% of screen
                );
              },
            ),
          ],
