                        ...
                        child: SizedBox(
                          ...
                          child: Center(
                            child: Column(
                              ...
                              children: [
                                Icon(
                                  state.isSearching ? Icons.search_off : Icons.psychology_outlined,
                                  size: 64,
                                  color: Colors.grey,
                                ),
                                const SizedBox(height: 16),
                                Text(
                                  state.isSearching 
                                      ? 'No preferences found for "${state.searchQuery}"'
                      ...
                      children: [
                        ...
                        if (state.isSearching)
                          Container(
                            ...
                            child: Text(
                              'Found ${state.items.length} result${state.items.length == 1 ? '' : 's'} for "${state.searchQuery}"',
                              style: TextStyle(
